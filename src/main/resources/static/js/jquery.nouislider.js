...
(function($, UNDEF){
	...
	$.fn.noUiSlider = function( options ){
		...
		function setHandle ( handle, to, forgive ) {
			...
			// if the handle bounce is trusted to the usermanage
		...
		function val ( args, modifiers ) {
			...
			return this.each(function(i, target){
				...
				$.each( $(this).data(clsList[12]), function( j, handle ){
					...
					// Handle usermanage facing input correction. The value is
					...
					// input that is not coming from usermanage facing elements.
